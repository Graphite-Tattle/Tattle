    ...
    $.fn.graphiteGraph = function() {
        return this.each(function() {
            ...
            var build_url = function (series) {
                ...
                return 'ajax/get_rawdata.php?'+when+'&check_id='+check_id;
            }

            var build_url_events = function (tags) {
                when = build_when()
                if (tags == "*") {
                    return 'ajax/alerts_json.php?'+when
                } else {
                    var check_id = $('#check_id').text();
                    return 'ajax/alerts_json.php?'+when+'&check_id='+check_id;
                }
            }
                        ...
                        success: function(req_data) {
                            ...
                            for (i in req_data) {
                                ...
                                markings.push({
                                    ...
                                    text:'<a data-controls-modal="graphite-event-modal_' +row.id+'" data-backdrop="static">'+row.what+'</a>'
