    ...
    <div class="span8">
      <form action="?<?=fURL::getQueryString(); ?>" method="post" class="form-horizontal">
        <div class="main" id="main">
	      ...
	      <label for="user-username" class="control-label">User Name<em>*</em></label>
              <div class="controls">
	    ...
	    <div class="control-group">
	      <label for="user-email" class="control-label">Email<em>*</em></label>
              <div class="controls">
           ...
           <? if ($action == 'edit') { ?>  
	    <div class="control-group">
	      <label for="user-password" class="control-label">Enter your password to confirm the changes<em>*</em></label>
              <div class="controls">
            ...
            <? } ?>
            <div class="control-group">
	      <label for="new-password" class="control-label">Password<em>*</em></label>
              <div class="controls">
                <input id="new-password" class="span3" type="password" size="30" name="new_password" value="" />
	      </div>
            </div>
            <div class="control-group">
	      <label for="confirm-password" class="control-label">Confirm the password<em>*</em></label>
              <div class="controls">
                <input id="confirm-password" class="span3" type="password" size="30" name="confirm_password" value="" />
	      </div>
            </div>
            	<? if ($action == 'edit') { ?>
            	</div>
	     ...
	     <? if ($action == 'edit') { ?>
	     	...
	     	<a href="#" id="btn_change_password" onclick="show_hide_new_password();return false" class="btn">Change password</a>
	     <?php } ?>
